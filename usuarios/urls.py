...
from .views import Crear_Usuarios, Lista_Usuarios, Menu_Usuarios, usuario_bloquear_desbloquear, usuario_eliminar, usuario_editar
from . import views
...
usuarios_urlpatterns = [
    ...
    path('bloquear/<int:id_usuario>/', views.usuario_bloquear_desbloquear, name='bloquear_usuarios'), 
